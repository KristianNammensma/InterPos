<div>
    <p>Product Received ID: {{ $product->id }}</p>
    {{-- <div class="card-body"> --}}
    ...
    <div class="form-items  d-flex flex-row flex-wrap justify-content-between ">
        @include('livewire.includes.Product.Edit.productEditInfo')


        @include('livewire.includes.Product.Edit.productEditPrice')
